...
const CartItem = () => {
  return (
    <Flex className="items-center flex-col md:flex-row justify-between gap-[15px] py-[14px] px-10 border-[1px] border-[#F4F4FF]">
      <div className="w-full md:w-5/12">
        <Flex className="items-center gap-5">
          <div className="h-[80px] w-[80px] rounded-[3px] bg-[#F4F4FF] p-2 2xl:py-3 2xl:px-[17px]">
            <div className="w-full h-full bg-gray-300"></div>
          </div>

          <h1 className=" font-dm font-normal text-[14px] 2xl:text-[16px] leading-[18px] text-secondarytext">
      ...
      <div className="w-full md:w-7/12">
        <Flex className="items-center flex-wrap justify-between">
          ...
          <div className="w-1/2 sm:w-1/3 md:w-1/4">
            <p className=" text-left md:text-center font-dm font-normal xl:text-[16px] leading-[18px] text-secondarytext">
              $130
            </p>
          </div>
          <div className="w-1/2 sm:w-1/3 md:w-1/4">
